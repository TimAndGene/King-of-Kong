...
Q.Sprite.extend("Player",{
  ...
  init: function(p) {
    ...
    this._super(p, {
      ...
      y: 600,           // be overridden on object creation
      });
    ...
    this.on("hit.sprite",function(collision) {
      ...
      if(collision.obj.isA("Enemy")) {
           // alert("Character has touched an enemy!");
      }

      if(collision.tile.isA(ladder)) {
            alert("Character has touched an enemy!");
      }
...
Q.load("sprites.png, sprites.json, level.json, ladders.json, tiles.png, background-wall.png, midground.png", function() {
